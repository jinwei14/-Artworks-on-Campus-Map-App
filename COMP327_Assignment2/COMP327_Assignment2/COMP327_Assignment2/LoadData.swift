...
//  COMP327_Assignment2
//
//  Created by Jinwei Zhang on 27/11/2017.
...
//added in.
class LoadData{
    var jsonURL = "https://cgi.csc.liv.ac.uk/~phil/Teaching/COMP327/artworksOnCampus/data.php?class=artworks2&lastUpdate="
    let imageBaseURL = "https://cgi.csc.liv.ac.uk/~phil/Teaching/COMP327/artwork_images/"
    ...
    public func loadJsonData(flag:Bool){
        ...
        if checkDataExist() == false {
            _ = loadJasonFromURL(date: "2017-11-01")
